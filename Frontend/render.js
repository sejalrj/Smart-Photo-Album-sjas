...
function uploadPhoto() {
  ...
  if ((filePath == "") || (!['png', 'jpg', 'jpeg'].includes(filePath.toString().split(".")[1]))) {
      ...
      let config = {
                headers:{'Content-Type': 'image/jpeg','x-amz-meta-customlabels': custom_labels.value}
            };

            url = 'https://fx5vuvu1n5.execute-api.us-east-1.amazonaws.com/v1/upload/ajs-album/'+ file.name
            console.log(url)
